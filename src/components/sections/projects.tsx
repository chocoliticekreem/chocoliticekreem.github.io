      ...
      <div className="grid gap-5 md:grid-cols-2">
        {projects.map((p) => (
          <a
            ...
            className="group relative flex flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 transition-colors duration-200 hover:border-emerald-400 hover:bg-emerald-50/40 dark:border-white/10 dark:bg-white/5 dark:hover:border-emerald-400/60 dark:hover:bg-emerald-400/5 cursor-pointer"
          >
            <div className="flex items-start justify-between gap-4">
              ...
              <ArrowUpRight className="h-5 w-5 shrink-0 text-slate-400 transition-transform duration-200 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 group-hover:text-emerald-500 dark:text-slate-500" />
            </div>
